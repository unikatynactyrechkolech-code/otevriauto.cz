...
export const pragueEastLocations: Location[] = [
  {
    slug: "brandys-nad-labem",
    name: "Brandýs nad Labem",
    locative: "v Brandýse nad Labem",
    region: "praha-vychod",
    geo: [50.1858, 14.6594],
    parts: ["Brandýs nad Labem", "Stará Boleslav", "Popovice"],
    ...
    hotspots: [
      ...
      "Masarykovo náměstí",
      "Mariánské náměstí ve Staré Boleslavi",
      "P+R u nádraží Brandýs nad Labem",
      "Nemocnice Brandýs nad Labem",
      "Exit Stará Boleslav na D10"
    ],
    tip: "Na Národní svatováclavskou pouť 28. září přijíždí do Staré Boleslavi mnoho poutníků. Pokud parkujete v ulici, kterou neznáte, zapište si její název – v případě zabouchnutých klíčů nás pak k autu snadno navedete.",
    faq: {
      question: "Přijedete i do Staré Boleslavi na druhém břehu Labe?",
      answer: "Ano. Brandýs nad Labem, Stará Boleslav i Popovice tvoří jedno město a otevíráme auta ve všech jeho částech. Při volání jen řekněte, na kterém břehu stojíte a u čeho, například u zámku, u baziliky svatého Václava nebo u nádraží Stará Boleslav."
    }
  },
  {
    slug: "ricany",
    ...
    hotspots: [
      ...
      "Obchody v Černokostelecké ulici",
      "Nemocnice Říčany",
      "Plovárna Jureček"
    ],
  ...
  },
  {
    ...
    tip: "Přívoz v Klecánkách převáží jen pěší a cyklisty, auto tedy zůstává na klecanském břehu. Než nastoupíte, zkontrolujte, že máte klíč u sebe a ne v kufru nebo brašně na nosiči – vracet se kvůli němu přes řeku zdrží.",
    faq: {
      question: "Otevřete i veterána, třeba po Klecanské Veteran Rallye?",
      answer: "Ano, otevíráme i starší vozy s mechanickými zámky a postupujeme u nich zvlášť opatrně, aby se nepoškodil lak ani původní těsnění. Při volání uveďte značku, model a přibližný rok výroby, ať technik veze vhodné nářadí."
    }
  },
  {
    slug: "libeznice",
    name: "Líbeznice",
    locative: "v Líbeznicích",
    region: "praha-vychod",
    geo: [50.1920, 14.4937],
    parts: ["Líbeznice"],
    ...
    hotspots: [
      "Mírové náměstí",
      "Sportovní a kulturní centrum Chrupavka",
      "Základní škola Líbeznice",
      "Zdravotní středisko Líbeznice",
      "Obchvat Líbeznic na I/9"
    ],
  ...
  },
  {
    ...
    hotspots: [
      "P+R Mnichovice",
      "Železniční zastávka Mnichovice",
      "Náměstí u kostela Narození Panny Marie",
      "Koupaliště Koupadlo",
      "Hubačovský rybník",
      "Letní kino Mnichovice"
    ],
    tip: "Na Koupadlo si klíč s dálkovým ovladačem neberte do vody ani do mokré tašky. Namočený ovladač často přestane vysílat a auto pak neodemknete – schovejte ho do vodotěsného obalu.",
    faq: {
      question: "Na P+R v Mnichovicích mi zamrzl zámek dveří. Otevřete auto, aniž byste zámek poškodili?",
      answer: "Ano. Zamrzlý zámek nikdy nepáčíme ani nepoléváme horkou vodou, která by v mrazu znovu zmrzla. Vůz otevřeme šetrně a po nastartování doporučujeme nechat topení chvíli pracovat, aby zámek i těsnění dveří rozmrzly."
    }
  },
  {
    slug: "mukarov",
  ...
  },
  {
    ...
    hotspots: [
      "Exit 8 Jirny na D11",
      "Logistický park Jirny",
      "Zámek Jirny",
      "Návesní rybník",
      "Kostel sv. Petra a Pavla",
      "Nákupní středisko Jirny"
    ],
    tip: "Jezdíte s dodávkou do logistického parku v Jirnech? Při nakládce nenechávejte klíč v zapalování ani na sedadle. Řada dodávek se po zabouchnutí dveří zamkne sama a náklad pak čeká i s vámi.",
    faq: {
      question: "Otevíráte v Jirnech i dodávky a užitková auta, nejen osobní vozy?",
      answer: "Ano. Dodávky a užitkové vozy všech značek otevíráme stejně šetrně jako osobní auta, ať stojí v logistickém parku za D11, nebo před domem v Nových Jirnech. Pokud je vůz v oploceném areálu, domluvte nám vjezd s ostrahou."
    }
  },
  {
    slug: "sibrina",
    ...
    hotspots: [
      "Zastávka Sibřina",
      "Zastávka Sibřina, Zahradní",
      "Zastávka Křenice, K Sibřině",
      "ZŠ a MŠ Sibřina",
      "Hřiště SK Viktoria Sibřina"
    ],
  ...
  },
  {
    ...
    tip: "Jezdíte z Hovorčovic vlakem S3? Než odejdete na nástupiště, sáhněte si do kapsy, že klíč máte opravdu u sebe. Některé vozy s bezklíčovým přístupem se dokážou zamknout i s klíčem odloženým v přihrádce.",
    faq: {
      question: "U haly v Hovorčovicích zůstalo dítě v zamčeném autě. Co mám dělat?",
      answer: "Pokud je v autě horko nebo dítě působí vystrašeně či malátně, volejte okamžitě 112 – záchranáři mohou okno rozbít. Když je situace klidná, zavolejte nám a auto otevřeme bez poškození. Do té doby zůstaňte u vozu a stíňte okna před sluncem."
    }
  },
  {
    slug: "mesice",
    ...
    hotspots: [
      ...
      "Zámek Měšice",
      "Hospodářský dvůr naproti zámku",
      "Silnice II/244"
    ],
    tip: "Když u stanice Měšice u Prahy zjistíte, že je klíč zamčený v autě, nezkoušejte dveře otevřít drátem přes okno – snadno poškodíte těsnění i elektroniku. Pokud musíte stihnout vlak, domluvte se s námi na otevření po návratu.",
    faq: {
      question: "Jsem na návštěvě v zámku v Měšicích a nemůžu hned odejít. Otevřete auto později?",
      answer: "Ano, čas příjezdu se dá domluvit tak, abyste mohli návštěvu v klidu dokončit. Řekněte nám, jestli auto stojí přímo v areálu, nebo před ním, a buďte na telefonu, ať vás technik po příjezdu zastihne."
    }
  },
  {
    slug: "zdiby",
    ...
    hotspots: [
      "Exit 1 Zdiby na D8",
      "Čerpací stanice u D8 ve Zdibech",
      "Začátek silnice I/9",
      "Kaňon Vltavy u Sedlce",
      "Zámek Zdiby",
      "Kostel Povýšení sv. Kříže"
    ],
    tip: "Při tankování na čerpací stanici u D8 ve Zdibech si berte klíč i telefon s sebou, i když jdete jen zaplatit. Zabouchnuté dveře s telefonem uvnitř znamenají, že nemáte ani čím zavolat pomoc.",
    faq: {
      question: "Jedu po D8 ze severu a klíč se mi zamkl v autě ve Zdibech. Přijedete i sem?",
      answer: "Ano. Zdiby leží hned za severní hranicí Prahy a otevíráme auta v celé obci včetně Brnek, Přemyšlení a Veltěže. Počkejte mimo jízdní pruhy na bezpečném místě a při volání popište, u které odbočky nebo firmy stojíte."
    }
  },
  {
    slug: "kamenice",
    ...
    hotspots: [
      ...
      "Zastávka Kamenice, Kulturní dům",
      "Zámek Štiřín",
      "Štiřínský rybník",
      "Kostel sv. Františka Serafinského"
    ],
    tip: "Silnice II/603 přes Kamenici je dopravně velmi vytížená. Když máte zamčené auto u krajnice, nečekejte na vozovce – postavte se mimo silnici a při volání řekněte, kterým směrem jste jeli a u které odbočky stojíte.",
    faq: {
      question: "Otevřete auto i ve Štiříně nebo ve Všedobrovicích?",
      answer: "Ano. Štiřín, Všedobrovice, Skuheř, Struhařov i další vesnice jsou místními částmi obce Kamenice a jezdíme do všech. Při volání uveďte název části a ulici nebo orientační bod, například zámek Štiřín, ať technik míří rovnou k vám."
    }
  },
  {
    slug: "velke-popovice",
    name: "Velké Popovice",
    locative: "ve Velkých Popovicích",
    region: "praha-vychod",
    geo: [49.9226, 14.6394],
    parts: [
      "Velké Popovice",
    ...
    hotspots: [
      ...
      "Ringhofferova ulice",
      "Obchody v Masarykově ulici",
      "Kostel Panny Marie Sněžné",
      "Zastávka Velké Popovice, Todice"
    ],
    tip: "Chcete ve Velkých Popovicích ochutnat pivo a auto nechat stát do druhého dne? Před odchodem zkontrolujte, že máte klíč u sebe, zhasnutá světla a zamčené dveře – ráno se vyhnete zabouchnutým klíčům i vybité autobaterii.",
    faq: {
      question: "Klíč je zamčený v autě u pivovaru, ale náhradní mám doma v Praze. Vyplatí se čekat?",
      answer: "Záleží na tom, kdo vám náhradní klíč přiveze a za jak dlouho. My přijedeme přímo k vozu a cenu otevření vám řekneme předem do telefonu, takže se můžete v klidu rozhodnout, co je pro vás výhodnější."
    }
  },
  {
    slug: "cestlice",
    name: "Čestlice",
    locative: "v Čestlicích",
    region: "praha-vychod",
    geo: [50.0026, 14.5837],
    parts: ["Čestlice"],
    ...
    hotspots: [
      ...
      "Makro Čestlice",
      "Bauhaus Čestlice",
      "Sjezd Čestlice na D1",
      "Kostel sv. Prokopa na návsi"
    ],
    tip: "Parkoviště v obchodní zóně Čestlice jsou rozlehlá a na první pohled si podobná. Při volání nám řekněte název nejbližšího obchodu a vchod nebo řadu, u které stojíte – technik vás najde bez bloudění.",
    faq: {
      question: "Při nakládání nákupu v Čestlicích jsem zabouchl klíč v kufru. Otevřete i kufr?",
      answer: "Ano. Obvykle otevřeme dveře řidiče a kufr pak odemknete tlačítkem nebo páčkou uvnitř vozu. U aut, kde to nejde, se ke klíči dostaneme jinou cestou – vždy bez poškození zámku, laku a elektroniky."
    }
  },
  {
    slug: "nehvizdy",
    name: "Nehvizdy",
    locative: "v Nehvizdech",
    region: "praha-vychod",
    geo: [50.1306, 14.7300],
    ...
    hotspots: [
      "Silnice II/611",
      "Kostel sv. Václava",
      "Pomník výsadku Anthropoid",
      "Zastávka Nehvizdy, škola",
      "Panská sýpka v Nehvízdkách"
    ],
    tip: "Při zastávce u pomníku výsadku Anthropoid u silnice II/611 si klíč vezměte do ruky dřív, než zabouchnete dveře. Auto nenechávejte s běžícím motorem ani kvůli krátkému focení.",
    faq: {
      question: "Otevřete auto zaparkované v garáži rodinného domu v Nehvizdech?",
      answer: "Ano, pokud je k vozu přístup alespoň k jedněm předním dveřím. Zkuste, jestli garážová vrata nejdou otevřít ručně nebo z domu, a při volání řekněte, jak těsně auto stojí u stěny."
    }
  },
  {
    slug: "zelenec",
    ...
    tip: "V nových ulicích Zelenče si při volání připravte přesnou adresu s číslem popisným. Nejnovější ulice nemusí všechny navigace znát a s přesnou adresou vás technik najde rychleji.",
    faq: {
      question: "Cestou z vlaku v Zelenči jsem ztratil klíče. Otevřete auto i bez nich?",
      answer: "Ano, auto otevřeme i bez klíče, abyste se dostali k dokladům, náhradnímu klíči nebo věcem uvnitř. Bez klíče ale vůz nenastartujete – pokud náhradní nemáte, je potřeba nechat vyrobit nový klíč v odborném servisu."
    }
  },
  {
    slug: "skvorec",
    ...
    hotspots: [
      "Náměstí ve Škvorci",
      "Zastávka Škvorec, náměstí",
      "Kostel sv. Anny",
      "Starý zámek Škvorec",
      "Silnice II/101"
    ],
    tip: "Přestal vám ve Škvorci fungovat ovladač? U většiny aut je v klíči schovaný mechanický nouzový klíč, kterým odemknete dveře řidiče. Vyzkoušejte ho dřív, než zavoláte – pokud zámek nepovolí, přijedeme.",
    faq: {
      question: "Vrátil jsem se autobusem 329 a klíč je zamčený v autě na náměstí ve Škvorci. Pomůžete i večer?",
      answer: "Ano, otevíráme nonstop, tedy i večer, v noci a o víkendu. Řekněte nám, na které straně náměstí auto stojí, a počkejte ideálně na osvětleném místě poblíž vozu."
    }
  }
];
