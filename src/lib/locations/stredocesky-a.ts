...
export const locationsA: Location[] = [
  ...
  },
  {
    ...
    intro: [
      "Na Masarykově náměstí ve Slaném a v okolních ulicích městské památkové zóny se v pracovní dny platí za parkování. Když se tu klíče zabouchnou v autě, parkovné mezitím dál běží – proto vyjíždíme bez odkladu a vůz otevřeme přímo na místě, šetrně a bez poškození dveří či zámku. Pomůžeme i ve chvíli, kdy klíče skončily v zamčeném kufru.",
      "Auta otevíráme u Nemocnice Slaný v ulici Politických vězňů, u zimního stadionu a aquaparku na západním okraji města i u nádraží. Vyjedeme také za řidiči, kteří zastavili u exitu 18 Slaný-jih na dálnici D7, a do místních částí jako Kvíc, Lotouš nebo Trpoměchy. Otevíráme auta všech značek včetně vozů s bezklíčovým přístupem a cenu víte ještě před výjezdem."
    ],
    ...
    faq: {
      ...
      answer: "Ano. Slánská hora s naučnou stezkou je oblíbené místo na procházku přímo ve městě a klíč se snadno zabouchne při převlékání nebo ukládání batohu do kufru. Řekněte nám, v jaké ulici pod horou auto stojí, a otevřeme ho bez poškození."
    }
  },
  // okres Beroun
  {
    ...
    intro: [
      ...
      "Kdo dojíždí do Prahy, často nechává auto u nádraží na koridoru Praha – Plzeň nebo na parkovišti P+R Na Podole pod dálničním mostem a dál jede vlakem. Vyjedeme tam stejně jako k exitu 18 Beroun-centrum na D5, k aquaparku Tipsport laguna nebo do Závodí, na Zavadilku a do Hostimi. Otevíráme osobní auta, dodávky i vozy s bezklíčovým startováním všech značek a cenu sdělíme předem."
    ],
    ...
    faq: {
      ...
      answer: "Ano. Po plavání se snadno stane, že klíč zůstane v tašce v kufru a auto se mezitím samo zamkne. Vůz otevřeme bez poškození zámku i elektroniky, abyste se ke svým věcem dostali. Při volání jen uveďte, že stojíte u aquaparku v ulici Na Ostrově."
    }
  },
  {
    slug: "kraluv-dvur",
    ...
    intro: [
      "Králův Dvůr za poslední dvě desetiletí výrazně vyrostl a dnes má přes deset tisíc obyvatel. Středem města prochází dálnice D5, která ho rozdělila a připravila o přirozené centrum, a poloha se tu proto nejsnáz popisuje podle obchodu nebo sjezdu z dálnice. Nám to jako orientace stačí – přijedeme nonstop a auto se zabouchnutými klíči otevřeme bez poškození zámku i laku.",
      "Otevíráme auta na parkovišti obchodního centra Litavka v Počaplech, u Albertu a OBI v Plzeňské ulici i u exitu 22 Beroun-západ. Vyjedeme také k zastávkám Králův Dvůr a Králův Dvůr-Popovice, kde nechávají auta lidé dojíždějící vlakem, a do Levína, Zahořan nebo Karlovy Huti. Poradíme si s osobními vozy, dodávkami i auty s bezklíčovým přístupem a o ceně víte předem, ne až po zásahu."
    ],
    ...
    faq: {
      ...
      answer: "Ano. Parkoviště obchodního centra Litavka má skoro dvě stě míst, takže nám při volání řekněte, u kterého obchodu auto stojí. Otevřeme ho bez poškození a pomůžeme i tehdy, když se klíč zamkne v kufru spolu s nákupem."
    }
  },
  // okres Rakovník
  {
    ...
    intro: [
      "Rakovník je přirozeným centrem řídce osídleného Rakovnicka, a tak sem lidé z okolních vesnic jezdí autem k lékaři, do Masarykovy nemocnice, na úřady i na nákupy. Když pak klíče zůstanou zamčené v autě na parkovišti u Kauflandu v Luženské ulici nebo na Husově náměstí, kde vjezd hlídají závory, přijedeme nonstop a vůz otevřeme bez poškození zámku, laku i elektroniky.",
      "Rakovník je také branou na Křivoklátsko – silnice II/227 odtud vede přímo ke Křivoklátu. Otevíráme auta u nádraží, u zimního stadionu, v okolí Pražské brány i u závodu P&G Rakona v Ottově ulici, kam se jezdí na směny. Poradíme si s osobními vozy, dodávkami i auty s bezklíčovým přístupem všech značek. Cena je vždy domluvená předem."
    ],
    ...
    faq: {
      ...
      answer: "Ano. Nemocnice stojí v ulici Dukelských hrdinů a auto se tu nechává v rychlosti před ambulancí nebo při návštěvě pacienta. Řekněte nám, u kterého vchodu nebo na jakém parkovišti stojíte, a vůz otevřeme bez poškození, i když klíč zůstal zamčený v kufru."
    }
  },
  // okres Mělník
  {
    ...
    faq: {
      ...
      answer: "Ano. Parkoviště Nad Soutokem leží asi 200 metrů od Vrázovy vyhlídky v ulici K Mostu, odkud je nejhezčí pohled na soutok Labe a Vltavy. Když se vám tu klíče zabouchnou, řekněte nám název parkoviště a auto otevřeme bez poškození."
    }
  },
  {
    ...
    intro: [
      "Kralupy nad Vltavou leží na obou březích řeky: na levém je centrum s nádražím, Lobeč, Mikovice a Minice, na pravém Lobeček se sídlištěm, zimním stadionem a rozsáhlým areálem chemičky a rafinerie. Mezi břehy vede most T. G. Masaryka, a proto se vždy ptáme, na které straně Vltavy auto stojí. Zabouchnuté klíče vyřešíme ve dne i v noci a bez poškození vozu.",
      "Dojíždějící do Prahy nechávají auta v parkovacím domě P+R v Havlíčkově ulici nebo přímo u nádraží. Vyjedeme k nim stejně jako k nemocnici v Mostní ulici, k plaveckému bazénu, k Lidlu ve Veltruské ulici nebo k vrátnicím průmyslové zóny v Lobečku. Otevíráme osobní auta, dodávky i vozy s bezklíčovým přístupem všech značek a cenu sdělíme ještě do telefonu."
    ],
  ...
  },
  {
    ...
    intro: [
      "Neratovice jsou už přes sto let spojené s chemickým průmyslem a areál Spolany patří k nejvýraznějším místům ve městě. Na směny se sem jezdí ve dne i v noci, a když si po noční směně zabouchnete klíče v autě, nemusíte čekat do rána. Vyjedeme nonstop k továrně, k panelovým domům na sídlišti i k rodinným domům v Byškovicích a vůz otevřeme bez poškození zámku a těsnění.",
      "Vlak staví ve městě hned na čtyřech místech – Neratovice, Neratovice sídliště, Neratovice město a Lobkovice – takže pokud necháváte auto u vlaku, řekněte nám, u kterého z nich stojí. Vyjedeme i k nemocnici a nové poliklinice u zastávky Neratovice sídliště, ke Kulturnímu domu nebo do Lobkovic k zámku a zdymadlu. Otevíráme auta všech značek, dodávky i vozy s bezklíčovým přístupem. Cenu znáte předem."
    ],
    ...
    faq: {
      ...
      answer: "Ano. U zastávky vzniklo v Mánesově ulici zhruba 35 míst P+R a parkují tu i návštěvníci polikliniky a nedaleké nemocnice. Řekněte nám, na které straně trati vůz stojí, a otevřeme ho bez poškození dveří, zámku i elektroniky."
    }
  }
];
